...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final int dbvesion = 29;
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String donHang = "CREATE TABLE DONHANG(" +
                ...
                " mataikhoan integer REFERENCES ADMIN(madonhang)," +
        ...
        String gioHang = "CREATE TABLE GIOHANG(" +
                ...
                "mataikhoan text REFERENCES ADMIN(mataikhoan)," +
...
//                "(2,'admin','2',200)");
        ...
        db.execSQL("INSERT INTO DONHANG VALUES(1,1,'Hưng KN','Thôn 9 Hà Nội','Giày Nike White','Nike','30/11/2023',3999,'Đã Nhận Hàng')," +
                "(2,2,'Thành KN','Thôn 9 Hà Nội','Giày Adidas','Adidas','30/11/2023',2999,'Đã Nhận Hàng')," +
                "(3,3,'Giang KN','Thôn 9 Hà Nội','Giày Bitis','Bitis','30/11/2023',4999,'Đã Nhận Hàng')");
